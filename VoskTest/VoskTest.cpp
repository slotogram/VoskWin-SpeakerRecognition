...
//using namespace kaldi;
	...
	int main()
	{
		...
		std::string train, test, trials;

		std::getline(infile, train);
		...
		for (int i = 0; i < 10; i++) {
			...
			vosk_create_speaker_xvectors(recognizer, "test_ulk.ark", "test_ulk_spk.ark");
			combine_xv_arks("test_ulk.ark", "test_ulk_test.ark");
